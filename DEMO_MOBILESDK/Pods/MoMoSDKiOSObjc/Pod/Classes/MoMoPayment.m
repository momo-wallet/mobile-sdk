...
-(void)requestToken{
    ...
    if ([paymentInfo isKindOfClass:[NSMutableDictionary class]]) {
        ...
        [paymentInfo setValue:@"202007031511"               forKey:@"buildversion"];
        ...
        if ([paymentInfo objectForKey:MOMO_PAY_CLIENT_PARTNER_CODE_KEY] != nil){
            ...
            [paymentInfo setValue:[paymentInfo objectForKey:MOMO_PAY_CLIENT_PARTNER_CODE_KEY]          forKey:MOMO_PAY_CLIENT_MERCHANT_CODE_KEY];
        }
        ...
        if ([paymentInfo objectForKey:MOMO_PAY_CLIENT_PARTNER_NAME_KEY] != nil){
            ...
            [paymentInfo setValue:[paymentInfo objectForKey:MOMO_PAY_CLIENT_PARTNER_NAME_KEY]          forKey:MOMO_PAY_CLIENT_MERCHANT_NAME_KEY];
        }
